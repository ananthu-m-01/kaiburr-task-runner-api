...
// handler for task not found exception
    ...
    public ResponseEntity<Map<String,Object>> handleTaskExecutionException(TaskExecutionException taskExecutionException){
        Map<String,Object> errorBody = new HashMap<>();
        errorBody.put("timestamp", LocalDateTime.now());
        errorBody.put("status", HttpStatus.INTERNAL_SERVER_ERROR.value());
        errorBody.put("error", "task execution error");
        errorBody.put("message", taskExecutionException.getMessage());
